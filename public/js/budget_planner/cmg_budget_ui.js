...
function drawTab(index, colorTab, titleTab, items, isLast) {
    ...
    $.each(items, function() {
        ...
        html = html + "<td class='second'><input maxlength='7' placeholder='0.00' type='text' class='dataInput' onblur='calculateInput(this)' onkeypress='return isNumberKey(event)' style='width:100%'></td>";
